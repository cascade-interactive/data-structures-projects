...
int main() {
    ...
    cout << "======================" << endl;
    // Loop for allowing the user to add, remove, search, and display hats in
    // the collection
    do {
        cout << "\nMain Menu\n"
             << "---------\n"
        ...
        case 4: {
            ...
            // Make use of bool to return true or false if the hat was found and
            // removed
            bool find_hat = hat_collection.remove(target_hat);
            if (!find_hat) {
                cout << "------------\nHat not found under specified "
                        "parameters.\n------------\n";
                break;
            }
        ...
        default:
            cout << "Invalid selection. Please choose one of the listed "
                    "options.\n";
            break;
        }
    } while (choice != 6);
